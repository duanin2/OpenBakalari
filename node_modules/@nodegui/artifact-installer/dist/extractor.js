...
var _7zip_min_1 = require("7zip-min");
var util_1 = __importDefault(require("util"));
var fs_1 = __importDefault(require("fs"));
var unpack7z = util_1.default.promisify(_7zip_min_1.unpack);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, fsExist(archivePath)];
                case 1:
                    if (!(_a.sent())) {
                        throw new Error("Archive " + archivePath + " doesnt exist!!");
                    }
                    return [4, unpack7z(archivePath, outDir)];
                case 2:
                    _a.sent();
                    return [2];
            }
