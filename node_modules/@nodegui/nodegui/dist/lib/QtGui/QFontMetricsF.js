...
exports.QFontMetricsF = void 0;
const addon_1 = __importDefault(require("../utils/addon"));
const Component_1 = require("../core/Component");
const helpers_1 = require("../utils/helpers");
const QSize_1 = require("../QtCore/QSize");
const __1 = require("../..");
class QFontMetricsF extends Component_1.Component {
    constructor(arg) {
        let native;
        if (helpers_1.checkIfNativeElement(arg)) {
            ...
            native = new addon_1.default.QFontMetricsF(arg.native);
        }
        super(native);
    }
    // *** Public Functions ***
...
exports.QFontMetricsF = QFontMetricsF;
